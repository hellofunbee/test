...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='专家答疑';
...
CREATE TABLE `exp_field` (
  `exp_field_id` int(11) NOT NULL COMMENT '专家领域id',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='专家服务项目';
