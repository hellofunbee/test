    ...
    $("#sjdl").click(function () {
        layer.open({
            ...
            success: function (page) {
                ...
                var uploadFileEl = $('<input style="float:left;left:0;top:0;opacity:0;cursor:pointer" type="file"/>');
                uploadFileEl.css({
                ...
                page.find(".btn-upload").click(function () {
                    ...
                    obj.append("d_type", dtype);
                    obj.append("d_state", 1);
                    obj.append("d_province", page.find("#gis2_provice").val());
                    obj.append("d_city", page.find("#gis2_city").val());
                    obj.append("d_district", page.find("#gis2_district").val());
                    obj.append("content", uploadFileEl.get(0).files[0]);
                    $.ajax({
                        url: apiPre + "/addDistribution2",
                        type: "post",
