$(function () {
    ...
    function addMapOverlay(title, shiyongzhe, zhidaozhuanjia, shengchanzhe, yunxingzhuangtai, guanlizhe, num) {
        ...
        var sContent = "<p class='gis-info' style='width:100%; float:none;'>" +
            "<span>设置名称：</span>" + title +
            "</p>" +
            "<ul style='overflow: hidden;font-size: 14px'>" +
            "<li class='gis-info'><span>使用者:</span>" + shiyongzhe + "</li>" +
            "<li class='gis-info'><span>指导专家:</span>" + zhidaozhuanjia + "</li>" +
            ...
            "<li class='info_5 gis-btn' onclick=\"window.openPageContent('专家系统')\">指导专家</li>" +
            "</ul>" + "</div>";
        return sContent
    }
