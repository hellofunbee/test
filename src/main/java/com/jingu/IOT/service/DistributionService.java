...
public class DistributionService {
	...
	public List<Map<String, Object>> listDistribution3(DistributionEntity2 de){
		...
		for (Map<String, Object> map : listDistribution2) {
			...
			DistributionEntity2 distributionEntity = new DistributionEntity2();
	...
	public Map<String, Object>  getLastProcess(Integer type ,Integer procedure) {
		...
		return distributionDao.getLastProcess(type,procedure);
