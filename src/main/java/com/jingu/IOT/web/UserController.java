...
//	}
	...
	public @ResponseBody IOTResult addPicture(@RequestParam("picture") MultipartFile picture,@RequestParam("cksid") String cksid,@RequestParam("ckuid") String ckuid,@RequestParam("oldfile") String oldfile){
...
//		}
	...
	public @ResponseBody IOTResult addSuperPicture(@RequestParam("picture") MultipartFile picture,@RequestParam("cksid") String cksid,@RequestParam("ckuid") String ckuid,@RequestParam("oldfile") String oldfile){
//		String check = toolUtil.getCheck(ToolUtil.CMS+ckuid);
//		if(check==null || !check.equals(cksid)){
//			return new IOTResult(false,"登陆失效",null,0);
//		}
