...
//	}
	public String getSettings(VAREntity var){
		String sql ="select ts_var_configstr from t_setting where ts_deviceId=?";
		try {
	...
	public int addSettings(VAREntity var){
		String sql ="insert into  t_setting (ts_deviceId,ts_var_ip,ts_var_configstr,ts_var_time,ts_var_state,ts_var_port) value (?,?,?,UNIX_TIMESTAMP(),?,?)";
	...
	public int creatTable(String name){
		String string = "t_vartriver_"+name;
		String sql = " create table "+string+" like t_vartriver_first";
